...
def populate_database():
    ...
    ip2 = IdentityProperties(property_name='personality', property_type='str', property_value_str='make friends', person=i)
    ip3 = IdentityProperties(property_name='interest', property_type='str', property_value_str='make friends', person=i)
    ip4 = IdentityProperties(property_name='occupation', property_type='str', property_value_str='robot', person=i)
    ip5 = IdentityProperties(property_name='nationality', property_type='str', property_value_str='french', person=i)
    ip6 = IdentityProperties(property_name='birthplace', property_type='str', property_value_str='france', person=i)
    ip7 = IdentityProperties(property_name='religion', property_type='str', property_value_str='freethinker', person=i)
    ip8 = IdentityProperties(property_name='race', property_type='str', property_value_str='robot', person=i)
    ip9 = IdentityProperties(property_name='birthday', property_type='datetime', property_value_datetime=datetime(year=2015, month=10, day=1), person=i)
    ipa = IdentityProperties(property_name='wealth', property_type='datetime', property_value_decimal=0.00, person=i)
    ...
    ipa = SocalProperties(property_name='wealth', property_type='datetime', property_value_decimal=10.00, person=s)
